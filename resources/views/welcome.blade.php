...
<header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
    @if (Route::has('login'))
        <nav class="flex items-center justify-end gap-4">
            ...
            @else
                <a
                    href="{{ route('support-request.create') }}"
    ...
    <main class="flex w-full">
        <section class="w-full">
            <div class="w-full flex justify-center flex-col">
                <h1 class="text-3xl font-bold leading-tight tracking-tight text-[#1b1b18] dark:text-[#EDEDEC] text-center">
                    Create a
                    Support request</h1>
                <a class="text-2xl font-bold leading-tight tracking-tight text-[#9999FF] dark:text-[#9999FF] text-center underline"
                   href="{{ route('support-request.create') }}">Send a request here</a>
            </div>
